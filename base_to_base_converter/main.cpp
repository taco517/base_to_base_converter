// base to base converted by taco
// inputs a number from base 2 to 16 then converts it to a chosen base
...
int main() {
    while (true) {
        ...
        do {
            ...
            break; // ff the input is a valid integer, break out of the loop
        ...
        // once the operation is done, code will prompt the user if they want to convert another value
        do {
            char choice;
            cout << "\nConvert another? (y/n): ";
            cin >> choice;
